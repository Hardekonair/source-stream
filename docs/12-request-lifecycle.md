...
- **Which model is used**: GPT-OSS 20B (`openai/gpt-oss-20b`)
...
|---|---|---|---|
| Groq | Fast LLM Inference (Guardrails, Routing, Generation) | GPT-OSS 20B (`openai/gpt-oss-20b`) | 4 times per request |
